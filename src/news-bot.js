...
client.on('interactionCreate',async i=>{
  ...
  }catch(e){await i.editReply({content:e instanceof PublicError?e.message:'News Desk could not complete this request. Check permissions or retry.',allowedMentions:{parse:[]}}).catch(()=>{});}
